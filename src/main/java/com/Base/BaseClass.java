...
//	}
	...
	public static void extentReportStart(String location) {
		try {
			...
			extentReports.setSystemInfo("Environment", FileReaderManager.getDataProperty("env"));
			extentReports.setSystemInfo("Application URL", FileReaderManager.getDataProperty("url"));
			extentReports.setSystemInfo("Browser Type : ", FileReaderManager.getDataProperty("browser"));
			extentReports.setSystemInfo("Browser Version : ", FileReaderManager.getDataProperty("browserVersion"));
			extentReports.setSystemInfo("Tester Name : ", FileReaderManager.getDataProperty("TesterName"));
			extentReports.setSystemInfo("Excution Type : ", FileReaderManager.getDataProperty("ExcutionType"));
			spark.config().setReportName("CROSS BROWSER TESTING");
			spark.config().setDocumentTitle("Test Cases of Automation Execution");
		} catch (Exception e) {
			e.printStackTrace();
		}
	}
